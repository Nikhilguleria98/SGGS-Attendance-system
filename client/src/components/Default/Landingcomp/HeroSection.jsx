            ...
            >
              ...
              >
                ...
                <button
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-2 bg-transparent border-2 border-[#132345] text-[#132345] hover:bg-[#132345] hover:text-white px-8 py-3.5 rounded-lg font-bold transition-all focus:ring-4 focus:ring-blue-100"
                >
                  Learn More
                </button>
              </motion.div>
