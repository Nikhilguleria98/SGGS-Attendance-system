...
export const sidebarMenus = {
  hod: [
    { label: 'HOD Dashboard', icon: Home, path: '/hod/dashboard' },
  ...
  teacher: [
    { label: "Teacher Dashboard", icon: Home, path: "/teacher/dashboard" },
  ...
  student: [
    { label: 'Student Dashboard', icon: Home, path: '/student/dashboard' },
